...
public abstract class MixinEntityPlayer extends EntityLivingBase {
    ...
    public void attackTargetEntityWithCurrentItem(Entity p_attackTargetEntityWithCurrentItem_1_) {
        ...
        if (p_attackTargetEntityWithCurrentItem_1_.canAttackWithItem()
            ...
            // 1.7.10: getEnchantmentModifierLiving and getKnockbackModifier take two EntityLivingBase params
            // Only computed for EntityLivingBase targets (non-living targets get 0)
            if (p_attackTargetEntityWithCurrentItem_1_ instanceof EntityLivingBase) {
                f1 = EnchantmentHelper.getEnchantmentModifierLiving(this,
                        (EntityLivingBase) p_attackTargetEntityWithCurrentItem_1_);
